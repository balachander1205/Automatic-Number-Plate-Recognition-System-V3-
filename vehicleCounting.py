...
cap = cv2.VideoCapture('E:/MY-PROJECTS/pythonRest-ANPR - V2/static/videos/Highway 01 - Free Video Footage - Background HD Free.mp4')
...
while True:
    ...
    if ret:  # if there is a frame continue with code
            ...
            if curcent:  # if there is a current centroid
                ...
                if oldcent:  # checks if old centroid exists
                    ...
                    if oldcent[1] >= lineypos2 and curcent[1] <= lineypos2 and carids[
                        ...
                        cv2.line(image, (0, lineypos2), (width, lineypos2), (0, 0, 255), 2)
                    ...
                    # to count cars and that car hasn't been counted yet
                        ...
                        cv2.line(image, (0, lineypos2), (width, lineypos2), (0, 0, 125), 2)
        ...
        cv2.putText(image, "Vehicle's in Area: " + str(currentcars), (0, 15), cv2.FONT_HERSHEY_SIMPLEX, .5, (0, 170, 0), 1)
 
        cv2.putText(image, "Vehicle's Crossed Up: " + str(carscrossedup), (0, 30), cv2.FONT_HERSHEY_SIMPLEX, .5, (0, 170, 0),
                    1)
 
        cv2.putText(image, "Vehicle's Crossed Down: " + str(carscrosseddown), (0, 45), cv2.FONT_HERSHEY_SIMPLEX, .5,
                    (0, 170, 0), 1)
 
        cv2.putText(image, "Total Vehicle's Detected: " + str(len(carids)), (0, 60), cv2.FONT_HERSHEY_SIMPLEX, .5,
                    (0, 170, 0), 1)
