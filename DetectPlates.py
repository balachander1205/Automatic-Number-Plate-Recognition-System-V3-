...
def detectPlatesInScene(imgOriginalScene):
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            # Drawing rectangle around number plate
            DrawRedRectangleAroundPlate.drawRedRectangleAroundPlate(imgContours, listOfPossiblePlates[i].rrLocationOfPlateInScene)
...
# detectPlatesInScene("F:/python-projects/ANPR-Projects/OpenCV_3_License_Plate_Recognition/LicPlateImages/1.png")
